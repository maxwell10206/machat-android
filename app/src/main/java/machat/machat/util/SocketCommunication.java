...
import machat.machat.parsing.BroadcastCompose;
import machat.machat.conf.SocketCommand;
import machat.machat.parsing.SocketCompose;
...
public class SocketCommunication implements OnCallbackAvatar {
    ...
    public SocketCommunication(final SocketService service, Socket mSocket) {
        ...
        mSocket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
            ...
            @Override
            public void call(Object... args) {
                JSONObject jsonObject = BroadcastCompose.getAvatar((JSONObject) args[0]);
